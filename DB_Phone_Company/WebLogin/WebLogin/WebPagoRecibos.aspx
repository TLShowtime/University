            ...
            <table style="width: 100%; text-align: center;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=LAPTOP-RCGTG6D0;Initial Catalog=Empresa;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT F.MontoTotalAPagar,F.FechaPago FROM dbo.Factura F inner join dbo.Contrato C on F.IdContrato = C.Id AND C.NumeroTelefono = ' + Convert.ToString(Session[&quot;Telefono&quot;])+' WHERE F.Estado = 1 AND F.Activo = 1" ></asp:SqlDataSource>                                                                   
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
